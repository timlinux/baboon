---
title: "Installation"
description: "Get Baboon running on your system in no time!"
weight: 1
icon: "📦"
donation: true
---
...
{{< callout "success" >}}
**Support Baboon Development** - Baboon is free, but not free to make! If you find it useful, please consider a small donation of **€10 / $10** to support ongoing development.
{{< /callout >}}
...
|----------|------|--------------|
| Linux | `baboon-linux-amd64` | x86_64 |
| Linux | `baboon-linux-arm64` | ARM64 |
| macOS | `baboon-darwin-amd64` | Intel |
| macOS | `baboon-darwin-arm64` | Apple Silicon |
| Windows | `baboon-windows-amd64.exe` | x86_64 |
...
{{< callout "info" >}}
**Recommended for Nix users** - Nix provides the most reproducible and cleanest installation experience.
{{< /callout >}}
...
Ready to start typing? Head over to the [Quick Start](/getting-started/quick-start/) guide!
