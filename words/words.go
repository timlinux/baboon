...
// CommonWords contains the 1000 most common English words
var CommonWords = []string{
	...
	"woman", "bring", "book", "problem", "better", "learn", "ask", "should", "America", "plant",
	"above", "girl", "sometimes", "without", "stop", "four", "second", "later", "program", "order",
	...
	"free", "black", "though", "level", "view", "important", "using", "center", "best", "sense",
	...
	"tax", "similar", "relationship", "personal", "single", "return", "experience", "form", "price", "American",
	...
	"offer", "degree", "term", "material", "able", "low", "performance", "either", "cover", "behavior",
	...
	"central", "pull", "note", "establish", "explain", "identify", "organization", "hair", "notice", "crime",
	...
	"dark", "eat", "doctor", "color", "stage", "shot", "trouble", "animal", "region", "assume",
	"develop", "popular", "collection", "fund", "drop", "perform", "hit", "bed", "remain", "original",
	"floor", "official", "deep", "foot", "carry", "pain", "behavior", "determine", "fight", "success",
	...
	"dream", "former", "finger", "stuff", "imagine", "glass", "defense", "corner", "nearly", "impact",
	...
	"decade", "pretty", "realize", "rise", "yard", "refer", "stone", "reflect", "limited", "huge",
	"connection", "count", "associate", "style", "extend", "absolutely", "damage", "variety", "spring", "complex",
	"truth", "collect", "commission", "executive", "recognize", "reform", "category", "significant", "citizen", "majority",
	...
	"essential", "sector", "length", "seriously", "hate", "spirit", "quiet", "equipment", "violence", "favor",
}
